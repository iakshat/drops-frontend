...
class BloodbankForm extends Component{
    ...
    handleSubmit = (e) => {
        ...
        //     userType : "bloodbank"
        // }
        var fd = new FormData(document.getElementById("bloodbank_form"));
        console.log(fd)
    ...
    render() {
        return(
            <div>
                <form onSubmit={this.handleSubmit}  id="bloodbank_form">
                    ...
                    <div className="input-field">
                        ...
                        <label htmlFor="address">Blood Banks's full Address</label>
                    </div>
                    <div className="input-field">
                        <input type="text" name="identity" placeholder="Blood Bank Identification Number" onChange={this.handleChange} />
                        <label htmlFor="identity">Blood Bank Identification Number</label>
                    </div>
                    <div className="input-field file-field">
                        <div className="btn btn-small">
                            <input type="file" onChange={this.handleFileChange} id="file-input"/>
                            <span>Upload Blood Bank Certificate</span>
                        </div>
                    ...
                    <input type="text" name="userType" value="bloodbank" className="hide"/>
...
export default withRouter(BloodbankForm);